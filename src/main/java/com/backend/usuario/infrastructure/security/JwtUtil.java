package com.backend.usuario.infrastructure.security;
...
public class JwtUtil {
    ...
    // Contrutor que gera uma chave secreta segura para assinatura usandi o algoritmo HS256
    public JwtUtil(){
    ...
    public String generateToken(String username) {
        return Jwts.builder()
                ...
                .signWith(secretKey) // Assina o tokencom a chavesecreta
